# T11：API 契約 v3 設計（已完結，施工紀錄）

狀態：✅ 已實作（2026-07-28，T11-01～08）。**本檔是動工前的設計草案，僅供查閱**——
仍在生效的結論已升級成 ADR-0004（不透明游標）、ADR-0005（色票／樣式代號放裝置端）、
ADR-0006（私人便條）；契約本體以 `docs/api/` 三份產出為準。兩者不一致時以 ADR 與契約為準。
日期：2026-07-27
